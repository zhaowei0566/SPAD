...
for elem = 1:size(FEM.elementNodes)
    ...
    for layer = 1:size(T0T1,1)
        ...
        theta(layer) = VAT_fiber_ply_angle_1D(T0,T1,centerX,center(1),Plate.length);
...
figure;set(gcf,'color','w');
subplot(1,3,1)
z3 =  griddata(centerX,centerY, NXX,x3,y3,'v4'); griddata(centerX,centerY, NXX,Plate.length/2,Plate.width/2,'v4')
...
subplot(1,3,2)
z3 =  griddata(centerX,centerY, NYY,x3,y3,'v4');griddata(centerX,centerY, NYY,Plate.length/2,Plate.width/2,'v4')
...
subplot(1,3,3)
z3 =  griddata(centerX,centerY, NXY,x3,y3,'v4'); griddata(centerX,centerY, NXY,Plate.length/2,Plate.width/2,'v4')
