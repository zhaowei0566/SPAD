function [stress,strain,displacement,SdisplacementL, generalized_strain]= ...
    StressRecoveryStiffeners_Orthotropic_multiStiffeners_average(FEM,Mat,Stiffener,ebar)
% ====================================================================
...
%         GaussLocations = GaussLocations(1);
...
%             
        ...
        strainL_average = strainL;% average stress
        
        ymid = 0;
        zmid = ebar;
        %         middle_poit = [ymid,zmid];
        strainL_gaussian_points (:,Gaussian_num) =   [    strainL_average(1) + zmid* strainL_average(4)
        ...
        stressL_center = CBAR*strainL_gaussian_points;
        ...
        strain(elem,:,stiffno) =      sum(strainL_gaussian_points,2)'/Gaussian_num;
        stress(elem,:,stiffno) =      sum(stressL_center,2)'/Gaussian_num;
        
        
        generalized_strain(elem,:,stiffno) = sum(strainL,2)/Gaussian_num;
    end
