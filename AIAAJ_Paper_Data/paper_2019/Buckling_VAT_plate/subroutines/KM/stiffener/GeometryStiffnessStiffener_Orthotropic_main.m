function[ KG_Stiffener,KGbeam_global ]= GeometryStiffnessStiffener_Orthotropic_main(FEM,Stiffener,ebar)
...
for stiffno = 1:stiffeners_number
   ...
   % system
    ...
    KGbeam_local = GeometryStiffnessStiffener_stress_recovery_multiStiffeners(FEM,Stiffener,StiffenerGaussPoint,ebar,stiffno);
    ...
    KG_Stiffener = KG_Stiffener+ShapeMatrixSP'*Tmatrix'*KGbeam_local*Tmatrix*ShapeMatrixSP;
