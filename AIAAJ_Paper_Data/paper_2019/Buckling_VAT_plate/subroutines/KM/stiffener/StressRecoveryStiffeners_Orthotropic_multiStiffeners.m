function [stress,strain,displacement,SdisplacementL, generalized_strain]=  StressRecoveryStiffeners_Orthotropic_multiStiffeners(FEM,Mat,Stiffener,ebar)
% ====================================================================
...
%             
        ...
        generalized_strain(elem,:,stiffno) = strainL;
    end
