function [K,Kelem]=LinearStiffnessLaminatedPlate_VAT_v2_X_constant_average_angle(Mat, Stru,FEM,Laminate,T0T1,center,physical_length)
    ...
    for ee=1:size(GaussWeights,1)
        ...
        for layer = 1:size(T0T1,1)
            ...
            for gauss_point_num=1:size(GaussWeights,1)
                ...
                theta(gauss_point_num) = VAT_fiber_ply_angle_1D(T0,T1,centerX,center,physical_length);
