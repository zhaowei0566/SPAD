...
main_program = 'E:\StiffenedPlate\StiffenedPlateCode\AIAAJ_Vibration_Code';
addpath([main_program '\subroutines\curve_function']);
addpath([main_program '\subroutines\FEM_pre']);
addpath([main_program '\subroutines\FEM_pre\bspline']);
addpath([main_program '\subroutines\FEM_post']);

addpath([main_program '\subroutines\KM']);
addpath([main_program '\subroutines\KM\Nsp']);
addpath([main_program '\subroutines\KM\plate']);
addpath([main_program '\subroutines\KM\stiffener']);


addpath([main_program '\subroutines\curve_function']);

addpath([main_program '\subroutines\MAT']);

addpath([main_program '\subroutines\FORCE']);
addpath([main_program '\subroutines\BC']);
%% Geometry Coordinates
Stru.bdfname='naturalspace12by12.bdf';
Stru.pathfile='E:\StiffenedPlate\StiffenedPlateCode\InputBDF';
FEMPara=geometryinfoplate(Stru);

Xcoord=FEMPara.nodesCord(:,2);
Ycoord=FEMPara.nodesCord(:,3);
Zcoord=FEMPara.nodesCord(:,4);
...
panel_point_1=[0,0];
panel_point_2=[0.3,0];
panel_point_3=[0.0,1.1];
panel_point_4=[-0.3,1.1];
...
curvature = 1;
DesignStep=curvature*[-1];

XINPUT=[0.75+xstep 0.50-xstep ];
...
figure(200);hold on; plot(platenodeX,platenodeY,'k.');axis image; hold on;
