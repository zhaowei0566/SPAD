function [stress,strain,displacement,SdisplacementL]=  StressRecoveryStiffeners_Orthotropic(FEM,Mat,Stiffener,ebar)
% ====================================================================
...
%         ShearStrain  = zeros(1,1);
        ...
        strainL_average = sum( strainL,2)/2; % average stress
